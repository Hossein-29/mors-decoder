...
begin
	case address is
	when "000000" =>data<=conv_std_logic_vector(char_to_integer ('W') ,8);  --the number of type integer into std_logic_vector
	...
	when "000100" =>data<=conv_std_logic_vector(char_to_integer ('D') ,8);
	when "000101" =>data<=conv_std_logic_vector(char_to_integer ('S') ,8);
	when "000110" =>data<=conv_std_logic_vector(char_to_integer ('P') ,8);
	when "000111" =>data<=conv_std_logic_vector(char_to_integer ('C') ,8);
	when "001000" =>data<=conv_std_logic_vector(char_to_integer ('o') ,8);
	when "001001" =>data<=conv_std_logic_vector(char_to_integer ('r') ,8);
	when "001010" =>data<=conv_std_logic_vector(char_to_integer ('e') ,8);
	when "001011" =>data<=conv_std_logic_vector(char_to_integer ('.') ,8);
	when "001100" =>data<=conv_std_logic_vector(char_to_integer ('i') ,8);
	when "001101" =>data<=conv_std_logic_vector(char_to_integer ('r') ,8);
	when "001110" =>data<=conv_std_logic_vector(char_to_integer (' ') ,8);
	when "001111" =>data<=conv_std_logic_vector(char_to_integer (' ') ,8);
	when "010000" =>data<=conv_std_logic_vector(char_to_integer ('F') ,8);
	when "010001" =>data<=conv_std_logic_vector(char_to_integer ('P') ,8);
	when "010010" =>data<=conv_std_logic_vector(char_to_integer ('G') ,8);
	when "010011" =>data<=conv_std_logic_vector(char_to_integer ('A') ,8);
	...
	when "010111" =>data<=conv_std_logic_vector(char_to_integer ('D') ,8);
	when "011000" =>data<=conv_std_logic_vector(char_to_integer ('S') ,8);
	when "011001" =>data<=conv_std_logic_vector(char_to_integer ('P') ,8);
