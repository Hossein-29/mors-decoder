...
begin
	...
	when "001011" =>data<=conv_std_logic_vector(char_to_integer ('d') ,8);
	when "001100" =>data<=conv_std_logic_vector(char_to_integer ('L') ,8);
	when "001101" =>data<=conv_std_logic_vector(char_to_integer ('o') ,8);
	when "001110" =>data<=conv_std_logic_vector(char_to_integer ('g') ,8);
	when "001111" =>data<=conv_std_logic_vector(char_to_integer ('i') ,8);
	when "010000" =>data<=conv_std_logic_vector(char_to_integer ('c') ,8);
	...
	when "010101" =>data<=conv_std_logic_vector(char_to_integer ('l') ,8);
